...
const soundPack: SoundPack = {
  ...
  padConfig: [
    ...
    {id: 3, sound: 'hi_hat', color: PAD_COLORS.DRUMS_ACCENT, icon: 'hi_hat'},
    {
      id: 4,
      sound: 'open_hat',
    ...
    {id: 5, sound: 'hi_hat_roll', color: PAD_COLORS.PERC_MAIN, icon: 'hi_hat'},
    {id: 6, sound: 'hit', color: PAD_COLORS.PERC_ACCENT, icon: 'hit'},
    {
      id: 7,
      sound: 'melody_1',
