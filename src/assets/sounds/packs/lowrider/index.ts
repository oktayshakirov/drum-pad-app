...
const soundPack: SoundPack = {
  ...
  padConfig: [
    ...
    {id: 2, sound: 'snare', color: PAD_COLORS.DRUMS_MAIN, icon: 'snare'},
    {id: 3, sound: 'open_hat', color: PAD_COLORS.DRUMS_MAIN, icon: 'open_hat'},
    {id: 4, sound: 'clap', color: PAD_COLORS.DRUMS_ACCENT, icon: 'clap'},
    {id: 5, sound: 'hit', color: PAD_COLORS.DRUMS_ACCENT, icon: 'hit'},
    {id: 6, sound: 'drums_1', color: PAD_COLORS.BASS_MAIN, icon: 'drums'},
    {id: 7, sound: 'drums_2', color: PAD_COLORS.BASS_MAIN, icon: 'drums'},
    {
      id: 8,
      sound: 'percussion',
    ...
    {id: 12, sound: 'sfx_gun', color: PAD_COLORS.SFX_MAIN, icon: 'gun'},
  ],
};
