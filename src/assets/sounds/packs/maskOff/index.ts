...
const soundPack: SoundPack = {
  ...
  padConfig: [
    ...
    {id: 4, sound: 'hit_1', color: PAD_COLORS.DRUMS_ACCENT, icon: 'hit'},
    {id: 5, sound: 'hit_2', color: PAD_COLORS.DRUMS_ACCENT, icon: 'hit'},
    {id: 6, sound: 'snare', color: PAD_COLORS.DRUMS_ACCENT, icon: 'snare'},
    {id: 7, sound: 'melody_1', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 8, sound: 'melody_2', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 9, sound: 'synth', color: PAD_COLORS.MELODY_ACCENT, icon: 'synth'},
    {id: 10, sound: 'chant_1', color: PAD_COLORS.BASS_MAIN, icon: 'chant'},
    {id: 11, sound: 'chant_2', color: PAD_COLORS.BASS_ACCENT, icon: 'chant'},
    {
      id: 12,
