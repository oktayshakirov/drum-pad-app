...
const soundPack: SoundPack = {
  ...
  padConfig: [
    {id: 1, sound: 'snare', color: PAD_COLORS.DRUMS_MAIN, icon: 'snare'},
    {id: 2, sound: 'hi_hat', color: PAD_COLORS.DRUMS_MAIN, icon: 'hi_hat'},
    {id: 3, sound: 'clap_1', color: PAD_COLORS.DRUMS_MAIN, icon: 'clap'},
    {id: 4, sound: 'clap_2', color: PAD_COLORS.DRUMS_ACCENT, icon: 'clap'},
    {id: 5, sound: 'hit_1', color: PAD_COLORS.DRUMS_ACCENT, icon: 'hit'},
    {id: 6, sound: 'hit_2', color: PAD_COLORS.DRUMS_ACCENT, icon: 'hit'},
    ...
    {id: 10, sound: 'bass_808', color: PAD_COLORS.BASS_ACCENT, icon: 'bass'},
    {id: 11, sound: 'melody_1', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 12, sound: 'melody_2', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 13, sound: 'melody_3', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 14, sound: 'melody_4', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 15, sound: 'synth_1', color: PAD_COLORS.MELODY_ACCENT, icon: 'synth'},
    {id: 16, sound: 'synth_2', color: PAD_COLORS.MELODY_ACCENT, icon: 'synth'},
    {
      id: 17,
      sound: 'chant_demon',
    ...
    {id: 20, sound: 'sfx_chains', color: PAD_COLORS.SFX_MAIN, icon: 'sfx'},
    {id: 21, sound: 'sfx_distortion', color: PAD_COLORS.SFX_MAIN, icon: 'sfx'},
    {
      id: 22,
    ...
    {id: 24, sound: 'sfx_glass', color: PAD_COLORS.SFX_ACCENT, icon: 'sfx'},
  ],
};
