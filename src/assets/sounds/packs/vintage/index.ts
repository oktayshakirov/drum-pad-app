...
const soundPack: SoundPack = {
  ...
  padConfig: [
    ...
    {id: 3, sound: 'snap', color: PAD_COLORS.DRUMS_MAIN, icon: 'snap'},
    {
      id: 4,
      sound: 'open_hat',
    ...
    {id: 5, sound: 'crash', color: PAD_COLORS.DRUMS_ACCENT, icon: 'open_hat'},
    {id: 6, sound: 'melody_1', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 7, sound: 'melody_2', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 8, sound: 'melody_3', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {id: 9, sound: 'melody_4', color: PAD_COLORS.MELODY_MAIN, icon: 'melody'},
    {
      id: 10,
      sound: 'vocals_1',
