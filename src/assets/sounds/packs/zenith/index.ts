...
const soundPack: SoundPack = {
  ...
  padConfig: [
    ...
    {id: 2, sound: 'clap', color: PAD_COLORS.DRUMS_MAIN, icon: 'clap'},
    {id: 3, sound: 'hi_hat', color: PAD_COLORS.DRUMS_MAIN, icon: 'hi_hat'},
    {id: 4, sound: 'crash', color: PAD_COLORS.DRUMS_ACCENT, icon: 'open_hat'},
    {id: 5, sound: 'drums_1', color: PAD_COLORS.DRUMS_ACCENT, icon: 'drums'},
    {id: 6, sound: 'drums_2', color: PAD_COLORS.DRUMS_ACCENT, icon: 'drums'},
    {
      id: 7,
      sound: 'percussion_1',
    ...
    },
    {
      id: 8,
      sound: 'percussion_2',
      color: PAD_COLORS.PERCUSSION_ACCENT,
      icon: 'percussion',
    },
